...
class cattle {
    ...
    static function edit($id=-1) {
        ...
        if ($info->id === -1) {
            ...
            $cols = array(
                'c'=>array('id', 'name', '__DATE_FORMAT(dob, \'%d/%m/%Y\') AS dob', 'category', 'section', 'height', 'description', 'icon', 'sire', 'dam', 'video', 'link', 'friendly_name'),
            ...
            if ($data[1] > 0) {
                ...
                $info->friendly_name = $data[0][0]['friendly_name'];
    ...
    static function update() {
        ...
        if (!is_null($common->getParam('submitted'))) {
            ...
            $friendlyName = $common->getParam('friendly_name');
